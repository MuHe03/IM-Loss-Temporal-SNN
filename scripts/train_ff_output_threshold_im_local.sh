...
output_dir="${run_root}/ff_output_3way/spiking_count_threshold_im"
...
echo "Running FF threshold-IM task ${TASK_ID}: dataset=${DATASET} seed=${seed} output_dir=${output_dir}"
printf 'Command:'
printf ' %q' "${cmd[@]}"
printf '\n'
exec "${cmd[@]}"
